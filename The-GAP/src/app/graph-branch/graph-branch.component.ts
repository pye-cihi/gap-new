...
@Component({
  selector: 'app-graph-branch',
  templateUrl: './graph-branch.component.html',
  styleUrls: ['./graph-branch.component.css']
})
export class GraphBranchComponent implements OnInit {
  public org_data = [];
  public graph_data = [];
  public cat = [];
